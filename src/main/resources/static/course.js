...
courseId = sessionStorage.getItem("courseId"); let elem = document.getElementById("units"); try {
let course = await $.ajax({
url: `/api/courses/${courseId}`, method: "get", dataType: "json"
});
document.getElementById("course").innerHTML = course.name; let html ="";
